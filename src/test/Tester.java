...
public class Tester {
    public static void main(String[] args) {
        ...
        List highestGradeSum = em.createQuery("SELECT SUM(sp.score) AS totalScore FROM Studypoint sp GROUP BY sp.studentId").getResultList();
        
        System.out.println(highestGradeSum + "213");
